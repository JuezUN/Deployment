...
sed 's@MONITOR_PATH@'${MONITOR_PATH}'@g;s@GRAFANA_PORT@'${GRAFANA_PORT}'@g;s@GRAFANA_DOMAIN@'${GRAFANA_DOMAIN}'@g;s@GRAFANA_URL@'${GRAFANA_URL}'@g' $DEPLOYMENT_PATH/monitoring/grafana/grafana.ini > /etc/grafana/grafana.ini
